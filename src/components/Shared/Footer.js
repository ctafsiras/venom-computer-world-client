...
const Footer = () => {
    ...
    return (
        <footer className="footer items-center p-4 mt-12 bg-neutral text-neutral-content">
            <div className="items-center grid-flow-col">
                ...
                <p>Venom Computer World | Copyright © {year} - All right reserved</p>
            </div>
            <div className="grid-flow-col gap-4 md:place-self-center mx-auto md:mr-0 md:justify-self-end">
